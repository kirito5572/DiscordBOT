...
public class FilterList {
    private static final String[] List= {
            ...
            "한남", "호구", "후장", "후빨", "ㅄ", "ㅅㅂ", "야발", "성관계", "발가락", "좃",
            "섹스", "시1발", "시발", "씨1발", "씨잘", "씨벌", "쎅스", "교미", "뒤진",
