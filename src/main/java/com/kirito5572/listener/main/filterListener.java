...
import com.kirito5572.objects.main.FilterList;
...
import static com.kirito5572.objects.main.linkConfirm.getLink;
...
public class filterListener extends ListenerAdapter {
    ...
    final String[] List = FilterList.getList();
    final String[] Lists = FilterList.getWebList();
    ...
    public void onGuildMessageUpdate(@Nonnull GuildMessageUpdateEvent event) {
        ...
        try {
            ...
            jda = event.getJDA();
            assert member != null;
            wordFilterMain(author, message, guild, member, messages, channel, jda);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void wordFilterMain(@NotNull User author, @NotNull Message message, @NotNull Guild guild, @NotNull Member member, @NotNull Message messages, @NotNull MessageChannel channel, @NotNull JDA jda) {
        String id = "";
        String rawMessage;
        try {
        ...
        try {
            ...
            String[] killfilterDisable = config.getKillfilterDisable();
                ...
                if (rawMessage.contains(s)) {
                    ...
                    try {
                        ...
                        if(channelId.equals("error")) {
                            ...
                            Objects.requireNonNull(guild.getTextChannelById(channelId)).sendMessageEmbeds(builder.build()).queue();
                        }
                    } catch (Exception e) {
