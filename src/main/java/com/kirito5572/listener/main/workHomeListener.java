        ...
        TimerTask job = new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    Objects.requireNonNull(guild.getTextChannelById("622076975258927125")).editMessageEmbedsById("657901600358137856", builder.build()).queue();
                    Objects.requireNonNull(guild.getTextChannelById("622076975258927125")).editMessageEmbedsById("657901620679540746", builder1.build()).queue();
                    Objects.requireNonNull(guild.getTextChannelById("622076975258927125")).editMessageEmbedsById("657901624316002364", builder2.build()).queue();
                    Objects.requireNonNull(guild.getTextChannelById("622076975258927125")).editMessageEmbedsById("657901627432501258", builder3.build()).queue();
                    Objects.requireNonNull(guild.getTextChannelById("622076975258927125")).editMessageEmbedsById("657901634747367425", builder4.build()).queue();
