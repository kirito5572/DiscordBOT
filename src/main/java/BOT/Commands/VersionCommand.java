...
public class VersionCommand implements ICommand {
    ...
    public void handle(List<String> args, @NotNull GuildMessageReceivedEvent event) {
        ...
        EmbedBuilder embedBuilder = EmbedUtils.getDefaultEmbed()
                ...
                .addField("CPU 사용량", "프로그램: " +String.format("%.2f", osBean.getProcessCpuLoad() * 100) +"% / 전체: " + String.format("%.2f", osBean.getSystemCpuLoad() * 100) + "%", true)
                .addField("CPU 정보 ", cpuInfo.getVendor() + " " + cpuInfo.getModel() + "@" + cpuInfo.getMhz() + "MHz", true)
                .addField("OS 정보", System.getProperty("os.name") + "(" + System.getProperty("os.arch") + ", " + System.getProperty("os.version") + ")", true)
